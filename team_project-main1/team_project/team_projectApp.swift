...
//                .environment(\.managedObjectContext, ApplicationData.preview.container.viewContext)
                .modelContainer(for: [ExerciseRoutineContainer.self, ExerciseDefaultModel.self,  ExerciseRecordContainer.self, ExerciseRecordModel.self])//, ExerciseRecordModel.self], isAutosaveEnabled: false)
