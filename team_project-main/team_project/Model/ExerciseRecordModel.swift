...
@Model
class ExerciseDefaultModel: Identifiable, Hashable {//}, Hashable {
...
class ExerciseRecordContainer {
    ...
    var exerciseData: [ExerciseRecordModel]?
    ...
    init(routinContainer: ExerciseRoutineContainer? = nil, exerciseDataModel: [ExerciseDefaultModel], recordDate: Date, totalTime: Int) {
...
class ExerciseRecordModel {
    ...
    init(recordContainer: ExerciseRecordContainer? = nil, id: UUID = UUID(), exerciseName: String, part: [ExercisePart], tool: ExerciseTool, set: Int, count: [Int], kg: [Int], done: [Bool]) {
